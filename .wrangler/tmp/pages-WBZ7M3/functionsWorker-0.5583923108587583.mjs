...
var onRequestGet2 = /* @__PURE__ */ __name(async (context) => {
  ...
  try {
    ...
    let limit = 63;
    if (period === "12h") {
      timeCondition = "AND s.created_at > (strftime('%s', 'now') - 43200)";
    } else if (period === "24h") {
      timeCondition = "AND s.created_at > (strftime('%s', 'now') - 86400)";
    } else if (period === "week") {
      timeCondition = "AND s.created_at > (strftime('%s', 'now') - 604800)";
    } else if (period === "all") {
      timeCondition = "";
    } else {
      timeCondition = "AND s.created_at > (strftime('%s', 'now') - 86400)";
...
// ../.wrangler/tmp/pages-WBZ7M3/functionsRoutes-0.38451250218845545.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-5zqj5b/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-5zqj5b/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5583923108587583.mjs.map
